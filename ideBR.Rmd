...
description: |
 Com o idebr é possível acessar, de forma fácil e leve, dados do índice de desenvolvimento da educação básica, diretamente do R, sem precisar fazer download algum.
preview: images/idebr.png
author:
  - name: Jonatas Silva do Espirito Santo 
    url: https://github.com/jonates/
    affiliation: Diretor de Pesquisas no SEI/SEPLAN/Governo da Bahia
