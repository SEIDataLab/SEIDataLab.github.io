...
Para os testes de performance de leitura e escrita de arquivos `csv` e `parquet`apresentando aqui neste post, foi utilizado um notebook lenovo, com processador intel core i7-4500U quad-core, , 16Gb de memória RAM e HD da WD com capacidade de 1 Tb.
