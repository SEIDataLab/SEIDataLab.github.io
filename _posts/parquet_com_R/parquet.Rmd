...
Além da `arrow`, outras biblioteca também disponibilizam funções para leituras de arquivos `csv`. O próprio R Base tem a função `read.delim()` (da biblioteca `utils`) para ler arquivos no formato de valores separados por caracter, conforme script abaixo:
