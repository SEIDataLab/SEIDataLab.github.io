...
Assumindo que o spark já está instalado no computador, primeiro deve ser criado uma conexão entre o RStudio e o Spark através da função `spark_connect`. Como será utilizado o Spark de forma "stand alone", no argumento `master`utilize o termo "local":
