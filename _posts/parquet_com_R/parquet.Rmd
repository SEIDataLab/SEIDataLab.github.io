...
MATRICULA_NORDESTE | 15.304.589 | 103    | 3.790.278 |   352,19
MATRICULA_NORTE    |  5.198.366 | 103    | 1.289.161 |    77,32
MATRICULA_SUDESTE  | 19.785.845 | 103    | 4.803.374 | 4.740,87
MATRICULA_SUL      |  6.932.126 | 103    | 1.703.439 |    93,76

Vale ressaltar que o readr não conseguiu ler o arquivo `MATRICULA_SUDESTE`, e foi feito com a biblioteca `arrow` através da função `read_delim_arrow`, cujo argumentos são os mesmos da `read_delim` do `readr`.
...
MATRICULA_NORDESTE | 15.304.589 | 103    | 3.790.278  | 2.008.247 | 47,8%    | 693,41
...
MATRICULA_SUL      |  6.932.126 | 103    | 1.703.439  |   777.771 | 54,3%    |  45,86
